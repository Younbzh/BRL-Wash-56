export const siteConfig = {
  ...
  about: {
    ...
    story: "J'ai créé BRL Wash 56 à 18 ans avec une idée simple : vous apporter un service de qualité professionnelle, directement chez vous. Né en Polynésie et vannetais depuis l'âge de 3 ans, je me suis équipé de matériel professionnel pour proposer un service à domicile de premier niveau.",
    mission: "Fourgon utilitaire aménagé, groupe électrogène, compresseur, aspirateur extracteur, nettoyeur haute pression : je suis 100% autonome. J'interviens même en appartement, sans accès à l'eau ni à l'électricité.",
    values: "La passion des voitures depuis tout petit, la rigueur d'un lycéen en Bac Pro Métiers de la Relation Client, et la détermination d'un jeune entrepreneur : voilà BRL Wash 56.",
    expertise: "Nettoyage intérieur voiture (3 formules dès 55€), nettoyage mobilier à domicile (canapés, matelas dès 30€), j'interviens chez vous ou sur votre lieu de travail."
  },
  ...
  process: {
    ...
    steps: [
      ...
      },
      {
        number: "02",
        title: "Devis",
        description: "Je vous propose un devis adapté à votre véhicule et vos besoins"
      },
      {
        number: "03",
        title: "Rendez-vous",
      ...
      },
      {
        number: "04",
        title: "Intervention",
        description: "Je m'occupe de votre véhicule avec mon matériel autonome"
      },
      {
        number: "05",
        title: "Résultat",
  ...
  faq: [
    {
      question: "Tu interviens vraiment à domicile ?",
      answer: "Oui, c'est mon point fort ! Je me déplace directement chez vous avec mon fourgon équipé, mon groupe électrogène et tout le matériel nécessaire. Vous n'avez pas besoin de vous déplacer."
    },
    {
      question: "Puis-je bénéficier du service en appartement ?",
      answer: "Absolument ! Grâce à mon groupe électrogène, je suis totalement autonome en électricité. J'interviens même si vous habitez dans un appartement en étage, sans accès à l'eau ni à une prise."
    },
    {
      question: "Quelle formule choisir ?",
      answer: "La formule Élégance (55€) convient pour un entretien régulier. La Signature (85€) est ma formule populaire avec plus de détails (déplacement inclus jusqu'à 8 km). L'Excellence (125€) c'est le nettoyage complet avec vapeur et soin du cuir (déplacement inclus jusqu'à 15 km)."
    },
    {
      question: "Tu fais aussi les canapés et matelas ?",
      answer: "Oui ! Je propose un nettoyage de mobilier à domicile : canapés et matelas. Les tarifs vont de 30€ (canapé 1 place) à 130€ (grand canapé 7-10 places). Devis personnalisé sur demande."
    },
    {
      question: "Comment fonctionne le paiement ?",
      answer: "Un acompte au début de la prestation, et le solde une fois le travail terminé et validé par vous. Aucune mauvaise surprise."
    },
    {
    ...
    {
      question: "Tu interviens hors de Vannes ?",
